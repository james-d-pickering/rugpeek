...
class Rug:
    ...
    def get_row_background(self):
        """
        Analyses the vertical and horizontal row of the matrix at the coordinate clicked by the user. The average value from each row is calulated and is then subtracted from the entire matrix across all the rows vertically and horizontally.
        """
        if self.axis:
